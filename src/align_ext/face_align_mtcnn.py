    ...
    with tf.Graph().as_default():
        with tf.device('/cpu:0'):
            ...
            with sess.as_default():
                pnet, rnet, onet = align_ext.detect_face.create_mtcnn(sess, model_dir)
...
def align_mtcnn_realplay(img, pnet, rnet, onet):
    ...
    bounding_boxes, _ = align_ext.detect_face.detect_face(img, minsize, pnet, rnet, onet, threshold, factor)
